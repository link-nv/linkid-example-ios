...
// LinkIDSDK
#define COCOAPODS_POD_AVAILABLE_LinkIDSDK
#define COCOAPODS_VERSION_MAJOR_LinkIDSDK 0
#define COCOAPODS_VERSION_MINOR_LinkIDSDK 0
#define COCOAPODS_VERSION_PATCH_LinkIDSDK 1
